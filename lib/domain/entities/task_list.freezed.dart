...
class _$TaskListImpl implements _TaskList {
  ...
  @override
  String toString() {
    return 'TaskList(id: $id, name: $name, color: $color, icon: $icon, sortOrder: $sortOrder, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, name, color, icon, sortOrder, createdAt, updatedAt);
...
abstract class _TaskList implements TaskList {
  const factory _TaskList(
      ...
      required final DateTime updatedAt}) = _$TaskListImpl;
